  ...
  draw_box()
{
  ...
  vst.vline(false, v0, v1);
  vst.vline(false, v0, v2);
  vst.vline(false, v0, v4);
  vst.vline(false, v1, v3);
  vst.vline(false, v1, v5);
  vst.vline(false, v2, v3);
  vst.vline(false, v2, v6);
  vst.vline(false, v3, v7);
  vst.vline(false, v4, v5);
  vst.vline(false, v4, v6);
  vst.vline(false, v5, v7);
  vst.vline(false, v6, v7);
}
