...
Hershey[] hershey_font = new Hershey[]{
    new Hershey(16, new int[]{
    }),
    new Hershey(10, new int[]{
        5,21, 5,7, -1,-1, 5,2, 4,1, 5,0, 6,1, 5,2,
    }),
    new Hershey(16, new int[]{
        4,21, 4,14, -1,-1, 12,21, 12,14,
    }),
    new Hershey(21, new int[]{
        11,25, 4,-7, -1,-1, 17,25, 10,-7, -1,-1, 4,12, 18,12, -1,-1, 3,6, 17,6,
    }),
    new Hershey(20, new int[]{
